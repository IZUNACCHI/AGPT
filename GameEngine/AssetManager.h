...
public:
	...
	// --- Textures ---
	// By default, textures use the AssetManager's default scale mode.
	...
	// NOTE: If the texture is already loaded, this will APPLY the requested mode
	...
	// Convenience overloads: apply a scale mode override to the
